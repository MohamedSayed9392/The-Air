...
import kotlinx.android.synthetic.main.simialr_tv_shows_item_list.view.*

class SimilarAdapter(val context: Context,
                     val list: List<TvShow>, val onItemClick:(TvShow)->Unit) : RecyclerView.Adapter<SimilarAdapter.LatestAdapterHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LatestAdapterHolder {
        return LatestAdapterHolder(LayoutInflater.from(parent.context).inflate(R.layout.simialr_tv_shows_item_list, parent, false))
    }
